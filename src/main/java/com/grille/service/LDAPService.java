    ...
    public LDAPObject LDAPget(String user, String mdp) throws Exception {
        ...
        try {
            ...
            while (results != null && results.hasMore()) {
                ...
                Attribute title = sr.getAttributes().get("title");
                promo = (String) title.get();
        ...
        LDAPObject reponse = new LDAPObject(login, mdp, nom, nomFamille, prenom, type, employeeNumber, mail, promo);
        return reponse;
